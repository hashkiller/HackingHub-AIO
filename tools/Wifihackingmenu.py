...
def Wifihackingmenu(nameofthemainclass):
    os.system(
    ...
    def menuchange():
        ...
        """)
        w = int(input("Enter The number of your Choise >>> "))
        if w == 1:
...
-------------------------------------------------------------------------------------------------                                                                     
    ...
    if var == 1:
        ...
        if os.path.exists("/usr/share/wordlists/rockyou.txt") == True:
            ...
            path = str(input(""))
            order = "aircrack-ng {} -w /usr/share/wordlists/rockyou.txt".format(
                path)
        ...
        print("\nEnter the path of the handshake file >>> ")
        path = str(input(""))
        print("\nEnter the path of your choosen wordlist >>> ")
        wordlist = str(input(""))
        order = ("aircrack-ng {} -w {}").format(path, wordlist)
        os.system(order)
        Wifihackingmenu()
    elif var == 8:
        print("\nEnter the ssid of the network (Be careful when you type it and use 'the name of the network') >>> ")
        essid = str(input(""))
        print("\nEnter the path of the handshake file >>> ")
        path = str(input(""))
        ...
        if attack == 1:
            ...
            channel = int(input(""))
            order = ("bully -b {} -c {} --pixiewps {}").format(bssid,
                                                               channel, interface)
            os.system(order)
            Wifihackingmenu()
        elif attack == 3:
